...
def build_roi_gaze_metadata(sample_dict: Dict[str, Any]) -> Tuple[torch.Tensor, torch.Tensor]:
...
def load_roi_candidate_lookup(
    ...
    lookup: Dict[str, Dict[str, List[List[float]]]] = {}
...
def build_roi_candidate_metadata(
    ...
    roi_candidate_lookup: Dict[str, Dict[str, List[List[float]]]],
