...
class LlavaQwenForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        cache_position=None,
        # focus_loss_after_phrase: Optional[bool] = None,
        # focus_loss_phrase_token_ids: Optional[Union[torch.Tensor, List[List[int]]]] = None,
        ...
        **kwargs,
        ...
        if dpo_forward:
            ...
            return super().forward(
                ...
                output_hidden_states=output_hidden_states,
                return_dict=return_dict,
                # focus_loss_after_phrase=focus_loss_after_phrase,
                # focus_loss_phrase_token_ids=focus_loss_phrase_token_ids,
                # focus_loss_missing_value=focus_loss_missing_value,
                **kwargs,
            )
