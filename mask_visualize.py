...
img_path = Path(r"D:\Projects\data\gazefollow\train\00000000\00000018.jpg")
mask_path = Path(r"D:\Projects\data\gazefollow\train_gaze_segmentations\masks\person__00000018_masks.npy")

# img_path = fix_wsl_paths(str(img_path))
# mask_path = fix_wsl_paths(str(mask_path))
#%%
img = cv2.imread(str(img_path))
mask = np.load(str(mask_path), allow_pickle=True).item()['static_masks'][0]
